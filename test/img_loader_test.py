...
class TestImageLoading(unittest.TestCase):
    ...
    def test_images_amount_from_link(self):
        ...
        self.assertEqual(len(get_all_images_from_link(self.links[1])), 3, error_msg)
    ...
    def test_images_amount_from_links(self):
        ...
        self.assertEqual(len(get_images_from_links([self.links[0], self.links[1]])), 4, error_msg)
        self.assertEqual(len(get_images_from_links([self.links[1], self.links[2]])), 23, error_msg)
        self.assertEqual(len(get_images_from_links([self.links[0], self.links[2]])), 21, error_msg)
        self.assertEqual(len(get_images_from_links([self.links[1], self.links[1]])), 6, error_msg)
